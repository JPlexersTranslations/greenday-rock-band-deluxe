...
"%~dp0dependencies/sed.exe" -i -e "s/prism_gem_emissive_//g" "%~dp0_ark\ui\track\gems\gems.dta"
"%~dp0dependencies/sed.exe" -i -e "s/3_player_//g" "%~dp0_ark\ui\track\gems\gems.dta"
...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0dependencies/superfreq.exe" png2tex "%~dp0custom_textures\gems/%%G" "%~dp0_ark\ui\track\gems\gen\%%~nG.png_xbox" --platform x360 --miloVersion 25
