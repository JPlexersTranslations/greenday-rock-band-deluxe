...
"%~dp0dependencies/sed.exe" -i -e "s/black_smasher_blue_//g" "%~dp0_ark\ui\track\smashers\smashers.dta"
"%~dp0dependencies/sed.exe" -i -e "s/black_smasher_green_//g" "%~dp0_ark\ui\track\smashers\smashers.dta"
"%~dp0dependencies/sed.exe" -i -e "s/black_smasher_norm_//g" "%~dp0_ark\ui\track\smashers\smashers.dta"
"%~dp0dependencies/sed.exe" -i -e "s/black_smasher_spec_//g" "%~dp0_ark\ui\track\smashers\smashers.dta"
"%~dp0dependencies/sed.exe" -i -e "s/drums_//g" "%~dp0_ark\ui\track\smashers\smashers.dta"
"%~dp0dependencies/sed.exe" -i -e "s/black_smasher_orange_//g" "%~dp0_ark\ui\track\smashers\smashers.dta"
"%~dp0dependencies/sed.exe" -i -e "s/black_smasher_red_//g" "%~dp0_ark\ui\track\smashers\smashers.dta"
"%~dp0dependencies/sed.exe" -i -e "s/black_smasher_yellow_//g" "%~dp0_ark\ui\track\smashers\smashers.dta"
...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0dependencies/superfreq.exe" png2tex "%~dp0custom_textures\smashers/%%G" "%~dp0_ark\ui\track\smashers\gen\%%~nG.png_xbox" --platform x360 --miloVersion 25
