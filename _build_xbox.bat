...
rd _temp
if %FAILED_ARK_BUILD% neq 1 (echo:Successfully built Green Day Rock Band Deluxe ARK. You may find the files needed to place on your Xbox 360 in /_build/Xbox/)
