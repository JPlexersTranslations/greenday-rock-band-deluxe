...
"%~dp0dependencies/arkhelper" dir2ark "%~dp0_ark" "%~dp0_build\ps3\USRDIR\gen" -n "patch_ps3" -e -v 5 >nul
...
rd _temp
echo:
if %FAILED_ARK_BUILD% neq 1 (echo:Successfully built Green Day Rock Band Deluxe ARK. You may find the files needed to place on your PS3 in /_build/PS3/)
