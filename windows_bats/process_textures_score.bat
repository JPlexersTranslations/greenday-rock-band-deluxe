...
"%~dp0..\dependencies/sed.exe" -i -e "s/indv_player_meter_//g" "%~dp0..\_ark\ui\track\score\score.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/circle_//g" "%~dp0..\_ark\ui\track\score\score.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/glass_//g" "%~dp0..\_ark\ui\track\score\score.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/glow_//g" "%~dp0..\_ark\ui\track\score\score.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/score_meter_wipe_//g" "%~dp0..\_ark\ui\track\score\score.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/star_power_//g" "%~dp0..\_ark\ui\track\score\score.dta"
...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/windows/superfreq.exe" png2tex "%~dp0..\custom_textures\score/%%G" "%~dp0..\_ark\ui\track\score\gen\%%~nG.png_xbox" --platform x360 --miloVersion 25
