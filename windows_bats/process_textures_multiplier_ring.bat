...
"%~dp0..\dependencies/sed.exe" -i -e "s/multiplier_cap_glass_vox_//g" "%~dp0..\_ark\ui\track\multiplier_ring\multiplier_ring.dta"
...
"%~dp0..\dependencies/sed.exe" -i -e "s/solid_//g" "%~dp0..\_ark\ui\track\multiplier_ring\multiplier_ring.dta"
...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/windows/superfreq.exe" png2tex "%~dp0..\custom_textures\multiplier_ring/%%G" "%~dp0..\_ark\ui\track\multiplier_ring\gen\%%~nG.png_xbox" --platform x360 --miloVersion 25
