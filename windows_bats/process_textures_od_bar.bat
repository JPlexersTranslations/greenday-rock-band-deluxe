...
"%~dp0..\dependencies/sed.exe" -i -e "s/player_meter_//g" "%~dp0..\_ark\ui\track\overdrive_bar\overdrive_bar.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/long_//g" "%~dp0..\_ark\ui\track\overdrive_bar\overdrive_bar.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/background_//g" "%~dp0..\_ark\ui\track\overdrive_bar\overdrive_bar.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/rising_sun_fx_small_//g" "%~dp0..\_ark\ui\track\overdrive_bar\overdrive_bar.dta"
...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/windows/superfreq.exe" png2tex "%~dp0..\custom_textures\overdrive_bar/%%G" "%~dp0..\_ark\ui\track\overdrive_bar\gen\%%~nG.png_xbox" --platform x360 --miloVersion 25
